...
def parse_args():
    ...
    parser.add_argument(
        ...
        choices=['comfort_ball', 'comfort_ball2', 'comfort_car_left', 'comfort_car_right'],
...
def expand_color_pairs(variations, color_candidates, n=None, seed=42):
    ...
    for v in variations:
        if v.get("variation") == "6angles_colors":
...
if __name__ == "__main__":
    ...
    elif args.dataset_name == "comfort_ball2":
        default_config = COMFORT_BALL_DEFAULT_CONFIG
        variations = COMFORT_BALL_VARIATIONS
        relations = COMFORT_BALL_RELATIONS
        dataset_name = "comfort_ball2"
